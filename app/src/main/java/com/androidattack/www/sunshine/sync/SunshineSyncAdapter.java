package com.androidattack.www.sunshine.sync;
...
import com.androidattack.www.sunshine.MainActivity;
import com.androidattack.www.sunshine.R;
import com.androidattack.www.sunshine.Utility;
import com.androidattack.www.sunshine.data.WeatherContract;
import com.androidattack.www.sunshine.data.WeatherContract.WeatherEntry;
import com.androidattack.www.sunshine.data.WeatherDbHelper;
...
//                Log.v(LOG_TAG, line);
        ...
        try {
            ...
            if (cVVector.size() > 0) {
                ...
                calendar.add(Calendar.DATE, -1); // yesterday's gate
    ...
    private void notifyWeather() {
        ...
        boolean displayNotifications = prefs.getBoolean(displayNotificationsKey,
                Boolean.parseBoolean(context.getString(R.string.pref_enable_notifications_true)));
        ...
        if (displayNotifications) {
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    //opening the app when user clicks on the app
